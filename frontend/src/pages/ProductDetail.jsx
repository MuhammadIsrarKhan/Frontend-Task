          ...
          <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div class="flex justify-between">
              ...
              <div className="flex gap-2">
                {" "}
                <button
                  class="flex ml-auto text-white bg-black border-0 py-2 px-6 focus:outline-none"
                  onClick={() => dispatch(addToCart(data))}
                >
                  Add to Cart
                </button>
                <button
                  class="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600"
